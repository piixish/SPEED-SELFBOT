...
module.exports = {
  ...
  run: async (client, message, args, db, prefix) => {
    ...
    message.edit(await language(client, `ღ __**samira - Utiles**__ ღ
> \`${prefix}pic <@user>\` ➜ **Permet de voir l'avatar de quelqu'un**
...
> \`${prefix}join <channelid>\` ➜ **Rejoindre un salon vocal**
...
`ღ __**samira - Utility**__ ღ
> \`${prefix}pic <@user>\` ➜ **Allows you to see someone's avatar**
...
> \`${prefix}join <channelid>\` ➜ **Join a vocal salon**
